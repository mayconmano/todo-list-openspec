...
O sistema SHALL exibir uma tela de login quando o usuário não estiver autenticado e tentar acessar uma rota protegida.
...
O sistema SHALL exibir uma tela de registro onde novos usuários podem criar uma conta.
